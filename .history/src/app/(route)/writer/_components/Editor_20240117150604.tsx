...
export default function Editor(){
    ...
    const saveData = () => {
        ...
        if(saveState === "normal")
        {
            icon = <FontAwesomeIcon className={saveState} icon={faClock} />
            msg = {edtDate};
        }
        else if(saveState === "ing")
        {
            icon = <FontAwesomeIcon className={saveState} icon={faCircleNotch} />
            msg = '저장중';
        }
        else if(saveState === "complete")
        {
            icon = <FontAwesomeIcon className={saveState} icon={faCircleCheck} />
            msg = {edtDate};
        }
        else if(saveState === "error")
        {
            icon = <FontAwesomeIcon className={saveState} icon={faCircleExclamation} />
            msg = '네트워크 오류';
        }
