...
export default function Infoot(){
    const [leageKey, setLeageKey] = useState<number>();
    const [teamKey, setTeamKey] = useState<number>();
    ...
    const playerKeyCallback = (key:number) => {
    ...
    const leageList = leages && leages.map((l:any) => (
        <li key={l.id}> 
